      ...
      <div ref={ref} className="absolute top-4 right-4 z-30">
        <div className="relative">
          <button onClick={toggleCart} className="bg-amber-50 p-3 rounded-full shadow-lg hover:bg-amber-100 transition-colors">
            {/* --- START: ADD THIS NEW CAKE BOX SVG --- */}
<svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-amber-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
  <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h14v8H5v-8z" />
  <path strokeLinecap="round" strokeLinejoin="round" d="M5 12l7-4 7 4" />
  <path strokeLinecap="round" strokeLinejoin="round" d="M9 8a3 3 0 016 0" />
</svg>
{/* --- END: ADD THIS NEW CAKE BOX SVG --- */}
            {cartItems.length > 0 && (
