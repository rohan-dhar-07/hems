...
const Register = () => {
    ...
    return (
        <div className="bg-gray-100 flex items-center justify-center min-h-screen p-4">
            <div className="register-container w-full max-w-md bg-white p-8 rounded-3xl shadow-2xl border-b-4 border-yellow-500 transform scale-100 transition-all duration-300">
                <div className="text-center mb-6">
                    <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Create Your Account</h1>
                    <p className="text-gray-500">Register to start your journey with Hems Bakery.</p>
                </div>
                ...
                <form className="space-y-4" onSubmit={registerWithEmail}>
                    <div className="form-element">
                        ...
                        <input type="text" id="username" value={username} onChange={(e) => setUsername(e.target.value)} className="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200 focus:ring-opacity-50" placeholder="e.g., JohnDoe" />
                    </div>
                    <div className="form-element">
                ...
                <div className="text-center text-sm text-gray-500 mt-6 form-element">
                    Already have an account? <a href="/login" className="font-semibold text-yellow-600 hover:underline">Log In</a>
                </div>
            </div>
        </div>
    );
